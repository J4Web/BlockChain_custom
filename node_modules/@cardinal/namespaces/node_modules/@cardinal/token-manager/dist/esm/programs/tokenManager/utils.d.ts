...
export declare const withRemainingAccountsForPayment: (transaction: Transaction, connection: Connection, wallet: Wallet, paymentMint: PublicKey, issuerId: PublicKey, paymentManagerId: PublicKey, receiptMint?: PublicKey | null, payer?: PublicKey) => Promise<[PublicKey, PublicKey, AccountMeta[]]>;
