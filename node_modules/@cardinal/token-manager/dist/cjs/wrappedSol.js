...
const splToken = (0, tslib_1.__importStar)(require("@solana/spl-token"));
const web3_js_1 = require("@solana/web3.js");
const _1 = require(".");
function withWrapSol(transaction, connection, wallet, lamports) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const nativeAssociatedTokenAccountId = yield (0, _1.withFindOrInitAssociatedTokenAccount)(transaction, connection, splToken.NATIVE_MINT, wallet.publicKey, wallet.publicKey);
