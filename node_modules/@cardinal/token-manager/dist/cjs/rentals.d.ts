...
export declare const claimRental: (connection: Connection, wallet: Wallet, tokenManagerId: PublicKey, timeInvalidatorId?: PublicKey | undefined) => Promise<Transaction>;
export declare const extendRentalExpiration: (connection: Connection, wallet: Wallet, tokenManagerId: PublicKey, paymentAmount: number) => Promise<Transaction>;
