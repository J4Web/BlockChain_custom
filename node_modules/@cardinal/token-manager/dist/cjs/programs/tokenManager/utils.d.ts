...
export declare const withRemainingAccountsForPayment: (transaction: Transaction, connection: Connection, wallet: Wallet, paymentMint: PublicKey, issuerId: PublicKey, receiptMint?: PublicKey | null | undefined, allowOwnerOffCurve?: boolean) => Promise<[PublicKey, PublicKey, AccountMeta[]]>;
