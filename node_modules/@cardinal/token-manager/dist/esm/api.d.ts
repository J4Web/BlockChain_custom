...
export declare const useTransaction: (connection: Connection, wallet: Wallet, mintId: PublicKey, usages: number, collector?: PublicKey | undefined) => Promise<Transaction>;
...
export declare const claimToken: (connection: Connection, wallet: Wallet, tokenManagerId: PublicKey, additionalOptions?: {
    otpKeypair?: Keypair | null | undefined;
    timeInvalidatorId?: PublicKey | undefined;
...
export declare const extendUsages: (connection: Connection, wallet: Wallet, tokenManagerId: PublicKey, paymentAmount: number) => Promise<Transaction>;
