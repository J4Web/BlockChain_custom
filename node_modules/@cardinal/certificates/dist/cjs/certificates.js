...
exports.withRevokeCertificateV2 = exports.withInvalidateCertificate = exports.withRevokeCertificate = exports.withUseCertificate = exports.withUnissueCertificate = exports.withClaimCertificate = exports.withIssueCertificate = void 0;
 ...
 */
async function withIssueCertificate(connection, wallet, transaction, params) {
    ...
    const [mintManagerId, mintManagerBump] = await web3.PublicKey.findProgramAddress([
        anchor.utils.bytes.utf8.encode(utils_1.MINT_MANAGER_SEED),
        params.certificateMint.toBuffer(),
    ], program.programId);
    const [certificateId, bump] = await web3.PublicKey.findProgramAddress([
        anchor.utils.bytes.utf8.encode(utils_1.CERTIFICATE_SEED),
        params.certificateMint.toBuffer(),
    ], program.programId);
    ...
    const certificateTokenAccount = await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, params.certificateMint, certificateId, provider.wallet.publicKey, true);
    ...
    if (params.originalMint) {
        const issuerOriginalMintTokenAccount = await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, params.originalMint, certificateId, provider.wallet.publicKey, true);
...
exports.withIssueCertificate = withIssueCertificate;
/**
 ...
 * @returns Transaction with instruction added
 */
async function withClaimCertificate(connection, wallet, transaction, params) {
    const provider = new anchor.AnchorProvider(connection, wallet, {});
    const program = new anchor.Program(utils_1.CERTIFICATE_IDL, utils_1.CERTIFICATE_PROGRAM_ID, provider);
    ...
    const recipientTokenAccountId = await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, certificate.mint, wallet.publicKey, wallet.publicKey, true);
    // assume this is here already
    const certificatePaymentTokenAccountId = certificate.paymentMint
        ? await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, 
        // @ts-ignore TODO
...
exports.withClaimCertificate = withClaimCertificate;
/**
 ...
 * @returns Transaction with instruction added
 */
async function withUnissueCertificate(connection, wallet, transaction, params) {
    const provider = new anchor.AnchorProvider(connection, wallet, {});
    const program = new anchor.Program(utils_1.CERTIFICATE_IDL, utils_1.CERTIFICATE_PROGRAM_ID, provider);
    const [mintManagerId] = await web3.PublicKey.findProgramAddress([
        anchor.utils.bytes.utf8.encode(utils_1.MINT_MANAGER_SEED),
    ...
    const issuerTokenAccount = await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, params.certificateMint, provider.wallet.publicKey, provider.wallet.publicKey, true);
...
exports.withUnissueCertificate = withUnissueCertificate;
/**
 ...
 */
async function withUseCertificate(connection, wallet, transaction, params) {
    const provider = new anchor.AnchorProvider(connection, wallet, {});
    const program = new anchor.Program(utils_1.CERTIFICATE_IDL, utils_1.CERTIFICATE_PROGRAM_ID, provider);
    const [certificateId] = await web3.PublicKey.findProgramAddress([
        anchor.utils.bytes.utf8.encode(utils_1.CERTIFICATE_SEED),
...
exports.withUseCertificate = withUseCertificate;
/**
 ...
 */
async function withRevokeCertificate(connection, wallet, transaction, params) {
    const provider = new anchor.AnchorProvider(connection, wallet, {});
    const program = new anchor.Program(utils_1.CERTIFICATE_IDL, utils_1.CERTIFICATE_PROGRAM_ID, provider);
    const [mintManagerId] = await web3.PublicKey.findProgramAddress([
        anchor.utils.bytes.utf8.encode(utils_1.MINT_MANAGER_SEED),
    ...
    const issuerTokenAccountId = await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, params.certificateMint, certificate.issuer, provider.wallet.publicKey, true);
    const certificatePaymentTokenAccountId = certificate.paymentMint
        ? await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, 
        // @ts-ignore TODO
        certificate.paymentMint, certificateId, provider.wallet.publicKey, true)
...
exports.withRevokeCertificate = withRevokeCertificate;
/**
 ...
 * @returns Transaction with instruction added
 */
async function withInvalidateCertificate(connection, wallet, transaction, params) {
    const provider = new anchor.AnchorProvider(connection, wallet, {});
    const program = new anchor.Program(utils_1.CERTIFICATE_IDL, utils_1.CERTIFICATE_PROGRAM_ID, provider);
    const [mintManagerId] = await web3.PublicKey.findProgramAddress([
        anchor.utils.bytes.utf8.encode(utils_1.MINT_MANAGER_SEED),
    ...
    const certificate = await program.account.certificate.fetch(certificateId);
    const certificateTokenAccountId = await splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, params.certificateMint, certificateId, true);
    const invalidatorTokenAccountId = await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, params.certificateMint, wallet.publicKey, provider.wallet.publicKey);
    let issuerTokenAccountId = invalidatorTokenAccountId;
    if (certificate.issuer.toString() !== wallet.publicKey.toString()) {
        issuerTokenAccountId = await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, params.certificateMint, certificate.issuer, provider.wallet.publicKey);
    }
    const certificatePaymentTokenAccountId = certificate.paymentMint
        ? await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, 
        // @ts-ignore TODO
...
exports.withInvalidateCertificate = withInvalidateCertificate;
/**
 * Adds revoke certificate instruction
 * @param connection
 * @param wallet
 ...
 * @returns Transaction with revoke certificate instruction added
 */
async function withRevokeCertificateV2(connection, wallet, transaction, params) {
    const provider = new anchor.AnchorProvider(connection, wallet, {});
    const program = new anchor.Program(utils_1.CERTIFICATE_IDL, utils_1.CERTIFICATE_PROGRAM_ID, provider);
    const [mintManagerId] = await web3.PublicKey.findProgramAddress([
        anchor.utils.bytes.utf8.encode(utils_1.MINT_MANAGER_SEED),
    ...
    const recipientPaymentTokenAccountId = certificate.paymentMint
        ? await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, 
        // @ts-ignore TODO
        certificate.paymentMint, certificate.recipient, provider.wallet.publicKey, true)
        : certificate.recipientTokenAccount;
    const issuerPaymentTokenAccountId = certificate.paymentMint
        ? await (0, utils_1.withFindOrInitAssociatedTokenAccount)(transaction, connection, 
        // @ts-ignore TODO
        certificate.paymentMint, certificate.issuer, provider.wallet.publicKey, true)
        : issuerTokenAccountId;
...
exports.withRevokeCertificateV2 = withRevokeCertificateV2;
