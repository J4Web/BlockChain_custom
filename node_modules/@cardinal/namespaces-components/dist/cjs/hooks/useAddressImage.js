...
const useAddressImage = (connection, address, namespaceName = constants_1.TWITTER_NAMESPACE_NAME, dev) => {
    ...
    const { displayName, loadingName } = (0, useAddressName_1.useAddressName)(connection, address, namespaceName);
    const refreshImage = (displayName) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (handle) {
                const imageUrl = yield (0, format_1.tryGetImageUrl)(namespaceName, handle, dev);
