...
const PostTweet = ({ wallet, appName, appTwitter, disabled, callback, cluster, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(TwitterButtonWrapper, Object.assign({ href: link, onClick: () => {
            window.open(link, '_blank');
            callback && callback();
        }, target: "_blank", rel: "noreferrer noopener" }, { children: (0, jsx_runtime_1.jsx)(TwitterButton, Object.assign({ variant: "primary", disabled: disabled }, { children: (0, jsx_runtime_1.jsxs)("div", Object.assign({ style: {
                    display: 'flex',
                    alignItems: 'center',
