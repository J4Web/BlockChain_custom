...
function tryGetImageUrl(namespace, name, dev) {
    var _a;
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            if (namespace === constants_1.TWITTER_NAMESPACE_NAME) {
                const response = yield fetch(`${(0, constants_1.apiBase)(dev)}/namespaces/twitter/proxy?url=https://api.twitter.com/2/users/by&usernames=${name}&user.fields=profile_image_url`);
...
function tryGetProfile(handle, dev) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch(`${(0, constants_1.apiBase)(dev)}/namespaces/twitter/proxy?url=https://api.twitter.com/2/users/by&usernames=${handle}&user.fields=profile_image_url`);
            const json = (yield response.json());
            return {
