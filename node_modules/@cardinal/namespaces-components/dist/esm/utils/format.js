...
export function tryGetImageUrl(namespace, name, dev) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (namespace === TWITTER_NAMESPACE_NAME) {
                const response = yield fetch(`${apiBase(dev)}/namespaces/twitter/proxy?url=https://api.twitter.com/2/users/by&usernames=${name}&user.fields=profile_image_url`);
...
export function tryGetProfile(handle, dev) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch(`${apiBase(dev)}/namespaces/twitter/proxy?url=https://api.twitter.com/2/users/by&usernames=${handle}&user.fields=profile_image_url`);
            const json = (yield response.json());
            return {
