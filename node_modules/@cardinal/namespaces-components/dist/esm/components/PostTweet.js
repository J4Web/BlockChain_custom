...
export const PostTweet = ({ wallet, appName, appTwitter, disabled, callback, cluster, }) => {
    ...
    return (_jsx(TwitterButtonWrapper, Object.assign({ href: link, onClick: () => {
            window.open(link, '_blank');
            callback && callback();
        }, target: "_blank", rel: "noreferrer noopener" }, { children: _jsx(TwitterButton, Object.assign({ variant: "primary", disabled: disabled }, { children: _jsxs("div", Object.assign({ style: {
                    display: 'flex',
                    alignItems: 'center',
                } }, { children: [_jsx(TwitterIcon, {}), _jsx("span", Object.assign({ style: {
                            position: 'relative',
                            bottom: '1px',
                            marginLeft: '6px',
                            marginRight: '12px',
