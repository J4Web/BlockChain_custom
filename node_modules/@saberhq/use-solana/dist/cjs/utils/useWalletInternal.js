...
const useWalletInternal = ({ onConnect, onDisconnect, network, endpoint, onError, storageAdapter, walletProviders, }) => {
    var _a;
            ...
            timeout = setTimeout(() => {
                ...
                void (() => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                    ...
                    while (shouldTryConnect) {
                        try {
                            yield wallet.connect(walletArgs);
                        }
                        catch (e) {
    ...
    const activate = (0, react_1.useCallback)((nextWalletType, nextWalletArgs) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        yield setWalletConfigStr(nextWalletConfigStr);
    }), [onError, setWalletConfigStr, wallet, walletConfigStr]);
    const disconnect = (0, react_1.useCallback)(() => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        yield (wallet === null || wallet === void 0 ? void 0 : wallet.disconnect());
        yield setWalletConfigStr(null);
