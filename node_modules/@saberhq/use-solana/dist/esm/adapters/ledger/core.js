...
export function signTransaction(transport, transaction, derivationPath = getSolanaDerivationPath()) {
    return __awaiter(this, void 0, void 0, function* () {
        const messageBytes = transaction.serializeMessage();
        return signBytes(transport, messageBytes, derivationPath);
    });
}
export function signBytes(transport, bytes, derivationPath = getSolanaDerivationPath()) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function getPublicKey(transport, derivationPath = getSolanaDerivationPath()) {
    return __awaiter(this, void 0, void 0, function* () {
